...
PRESETS: list[dict] = [
    ...
    # ── 7. Отряд РХБ защиты ────────────────────────────────────────────────────
    # 4 группы: дежурные силы (быстрое реагирование) + три группы основных
    # сил («Ч»+3.00). Иерархия из исходного Word («Основные силы → Группа X»)
    # сплющена в плоскую — каждая подгруппа отдельной группой шаблона.
    {
        "id": "rhb_defense",
        "name": "Отряд РХБ защиты",
        "description": "Состав отряда радиационной, химической и биологической "
                       "защиты. Дежурные силы («Ч»+0.05) + основные силы «Ч»+3.00 "
                       "(группа управления, РХР, спец. и санитарной обработки).",
        "columns": COLS_STANDARD,
        "groups": [
            {"name": "Дежурные силы реагирования («Ч»+0.05)", "slots": [
                {"position": "старший расчёта РХР",       "department": "3 упр."},
                {"position": "химик-дозиметрист",         "department": "3 упр."},
                {"position": "водитель АРХР Ford",        "department": "3 упр."},
            ]},
            {"name": "Основные силы («Ч»+3.00) — Группа управления", "slots": [
                {"position": "командир отряда",           "department": "НУ-3"},
                {"position": "начальник штаба",           "department": "НС РХБЗ"},
                {"position": "начальник связи",           "department": "по графику"},
                {"position": "водитель Лада Нива",        "department": "Б(О)"},
            ]},
            {"name": "Основные силы — Группа радиационно-химической разведки", "slots": [
                {"position": "старший группы",            "department": "3 упр."},
                {"position": "химик-дозиметрист",         "department": "3 упр."},
                {"position": "водитель АРХР УАЗ",         "department": "3 упр."},
            ]},
            {"name": "Основные силы — Группа специальной и санитарной обработки", "slots": [
                {"position": "старший группы",                              "department": "3 упр."},
                {"position": "химик-дегазатор",                             "department": "3 упр."},
                {"position": "химик-дегазатор",                             "department": "3 упр."},
                {"position": "химик-дегазатор",                             "department": "3 упр."},
                {"position": "химик-дегазатор",                             "department": "3 упр."},
                {"position": "химик-дегазатор",                             "department": "3 упр."},
                {"position": "химик-дегазатор – водитель КПССО КамАЗ",      "department": "3 упр."},
                {"position": "химик-дегазатор – водитель КПССО КамАЗ",      "department": "3 упр."},
                {"position": "химик-дегазатор – водитель МКСО КамАЗ",       "department": "3 упр."},
            ]},
        ],
    },

    # ── 8. Пиротехнические расчёты 5 управления ──────────────────────────────

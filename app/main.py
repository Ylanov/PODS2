...
from app.api.v1.routers import phone_import as phone_import_router
...
app.include_router(phone_import_router.router, prefix="/api/v1/admin",             tags=["Импорт телефонов (admin)"])
